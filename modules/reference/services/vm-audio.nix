...
#    ];
    ...
    hardware.pulseaudio = {
        enable = true;
        extraConfig = "
            load-module module-tunnel-sink sink_name=${speakerName} server=audio-vm:4713 format=s16le channels=2 rate=48000
            load-module module-tunnel-source source_name=${micName} server=audio-vm:4713 format=s16le channels=1 rate=48000
